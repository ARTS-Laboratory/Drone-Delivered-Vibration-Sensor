...
plt.title('001 FFT Spectrum Comparison')
...
plt.tight_layout()
plt.savefig('C:/Users/giese/OneDrive/Documents/GitHub/Drone-Delivered-Vibration-Sensor/system_design/International Gateway/V0.1/Software/Arduino/Shaker Data Collection/001_FFT_Spectrum_Comparison.png')
...
plt.xlim(0,10)
plt.title('001 Acceleration Comparison')
plt.tight_layout() # makes sure plot is neat and sizings work together
plt.savefig('C:/Users/giese/OneDrive/Documents/GitHub/Drone-Delivered-Vibration-Sensor/system_design/International Gateway/V0.1/Software/Arduino/Shaker Data Collection/001_Acceleration_Comparison.png', dpi=300)
...
plt.ylabel('Amplitude (dB)')
plt.xlabel('Frequency (Hz)')
plt.title('001 FFT Smoothed Spectrum Comparison')
# Zoom near region of interest
plt.xlim(0,200) # up to Nyquist (fs/2 = 200)
plt.ylim(-170,-30)
#Find and mark peak
...
plt.tight_layout()
plt.savefig('C:/Users/giese/OneDrive/Documents/GitHub/Drone-Delivered-Vibration-Sensor/system_design/International Gateway/V0.1/Software/Arduino/Shaker Data Collection/001_FFT_Smoothed_Spectrum_Comparison.png')